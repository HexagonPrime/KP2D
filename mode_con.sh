...
conda activate kp2d
python train_keypoint_net.py --file kp2d/configs/v4.yaml --training_mode consecutive --pretrained_model /scratch_net/biwidl306_second/shecai/pretrained_models/v4.ckpt